...
function MenuPage() {
  const menuItems = [
...

    {
      ...
      name: "Super crepe",
      flavors:
        "Nutella, strawberry, blueberry, pineapple, banana and honeydew melon",
      price: "79 kr",
    },
...

    {
      ...
      name: "Crepe rolls",
      flavors:
        "Nutella, strawberry, blueberry, pineapple, banana, honeydew melon and brownie",
      price: "79 kr",
    },
  ];
  return (
    <div>
      <p className="title" id="main_menu_title">
        C R E P E
      </p>
